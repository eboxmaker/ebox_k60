...
//I2Cx中断使能函数
void i2c_enable_irq(I2C_InitTypeDef);
//I2Cx中断禁止函数
void i2c_disable_irq(I2C_InitTypeDef);
//I2Cx产生开始信号函数
void i2c_start(I2C_Type *);
//I2Cx产生停止信号函数
void i2c_stop(I2C_Type *);
//I2Cx等待ACK信号函数
void i2c_wait_ack(I2C_Type *, uint8_t);
//I2Cx再次产生开始信号函数
void i2c_restart(I2C_Type *);
//I2Cx发送一个字节函数
void i2c_write_byte(I2C_Type *, uint8_t);
//I2Cx读取一个字节函数
uint8_t i2c_read_byte(I2C_Type *);
//I2Cx主机读写模式配置函数
void i2c_set_master_WR(I2C_Type *, uint8_t);
//I2C开始传输函数，需要设置外围设备地址和读写模式
void i2c_start_trans(I2C_Type *, uint8_t, uint8_t);
