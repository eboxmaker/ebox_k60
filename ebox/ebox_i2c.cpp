 ...
 *    1--配置成功
 */
uint8_t I2C::i2c_init(I2C_InitTypeDef i2c_init_structure)
{
 ...
 *
 */  
uint8_t I2C::i2c_deinit(I2C_InitTypeDef i2c_init_structure)
{
  I2C_Type *i2cx = i2c_init_structure.I2C_I2Cx;
 ...
 *
 */  
void I2C::i2c_enable_irq(I2C_InitTypeDef i2c_init_structure)
{
  I2C_Type *i2cx = i2c_init_structure.I2C_I2Cx; 
 ...
 *
 */  
void I2C::i2c_disable_irq(I2C_InitTypeDef i2c_init_structure)
{
  I2C_Type *i2cx = i2c_init_structure.I2C_I2Cx;
  i2cx->C1 &= ~I2C_C1_IICIE_MASK;
 ...
 *    无
 */
void I2C::i2c_start(I2C_Type *i2cx)
{
 ...
 *    无
*/
void I2C::i2c_restart(I2C_Type *i2cx)
{
 ...
 *    无
 */
void I2C::i2c_stop(I2C_Type *i2cx)
{
  i2cx->C1 &=(~I2C_C1_MST_MASK);
  i2cx->C1 &=(~I2C_C1_TX_MASK); 
}
 ...
 *    无
 */
void I2C::i2c_wait_ack(I2C_Type *i2cx, uint8_t is_wait)
{
  uint16 time_out;
 ...
 *
 */
void I2C::i2c_write_byte(I2C_Type *i2cx, uint8_t data8)
{
  i2cx->D = data8; 
}
...
uint8_t I2C::i2c_read_byte(I2C_Type *i2cx)
{
  uint8_t temp;
  temp = i2cx->D; 
  return temp;
 ...
 *    无
 */
void I2C::i2c_set_master_WR(I2C_Type *i2cx, uint8_t mode)
{
  if(mode==I2C_MRSW) 
    i2cx->C1 &= (~I2C_C1_TX_MASK);
  else
 ...
 *    无
 */
void I2C::i2c_start_trans(I2C_Type *i2cx, uint8_t addr, uint8_t mode)
{
  //I2C产生start信号
  i2c_start(i2cx);
  //将从机地址和主机读写位合成一个字节写入
  i2c_write_byte(i2cx, (addr<<1)|mode );
}
