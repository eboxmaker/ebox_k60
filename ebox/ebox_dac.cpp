...
void Dac::begin(void)
{
  ...
  //仅需初始化DAC通道即可
  dac_init_struct.DAC_Dacx = dac;
  dac_int(dac_init_struct);
}
 ...
 *    1--配置成功
 */
uint8_t Dac::dac_deinit(DAC_InitTypeDef dac_init_struct)
{
  uint8_t x;
  DAC_Type *dacx = dac_init_struct.DAC_Dacx;
 ...
 *    1--配置成功
 */
uint8_t Dac::dac_enable_irq(DAC_InitTypeDef dac_init_struct)
{
  uint8_t x;
  DAC_Type *dacx = dac_init_struct.DAC_Dacx;
 ...
 *    1--配置成功
 */
uint8_t Dac::dac_disable_irq(DAC_InitTypeDef dac_init_struct)
{
  uint8_t x;
  DAC_Type *dacx = dac_init_struct.DAC_Dacx;
 ...
 *    无
 */
void Dac::dac_set_buffer_dataN(DAC_Type *dacx, uint16_t data, uint8_t num)
{
  //参数检查
 ...
 *    无
 */
void Dac::dac_set_buffer_data(DAC_Type *dacx, uint16_t *data, uint8_t len)
{
  //参数检查
 ...
 *    无
 */
void Dac::dac_software_trigger(DAC_Type *dacx)
{
