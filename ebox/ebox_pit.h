...
uint8_t pit_init(PIT_InitTypeDef);
//PIT反初始化函数，关闭选择的PITx
void pit_deinit(PIT_InitTypeDef);
//使能PITx中断
void pit_enable_irq(PIT_InitTypeDef);
//禁用PITx中断
void pit_disable_irq(PIT_InitTypeDef);
};
#endif /* __HW_PIT_H__ */
