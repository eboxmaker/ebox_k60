...
private:
//SPI初始化函数
uint8_t spi_init(SPI_InitTypeDef );
//SPI反初始化函数
uint8_t spi_deinit(SPI_InitTypeDef );
//SPI使能外设中断
uint8_t spi_enable_irq(SPI_InitTypeDef );
//SPI禁止外设中断
uint8_t spi_disable_irq(SPI_InitTypeDef );
//SPI主机读写函数
uint8_t spi_master_write_read(SPI_Type * ,uint8_t ,uint8_t ,uint8_t);
//SPI主机读函数
uint8_t spi_master_read(SPI_Type *);
//SPI主机写函数
void spi_master_write(SPI_Type * ,uint8_t ,uint8_t ,uint8_t);
};
/********************************************************************/
